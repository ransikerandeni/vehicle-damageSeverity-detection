...
app.config['ALLOWED_EXTENSIONS'] = set(['jpg', 'jpeg', 'JPEG'])
...
def upload():
    ...
    if file and allowed_file(file.filename):
        ...
        file_name_full_path = os.path.join(
...
def predict():
    ...
    if (human_string == 'car'):
        label_text = 'This is not a damaged car with accuracy ' + \
        ...
        label_text = 'This is a low damaged car with ' + \
            str(score) + '% accuracy.'
        print(image_path)
        return render_template('front.html', text=label_text, filename=image_path)
    elif (human_string == 'high'):
        label_text = 'This is a high damaged car with ' + \
            str(score) + '% accuracy.'
        print(image_path)
        return render_template('front.html', text=label_text, filename=image_path)
    elif (human_string == 'not'):
        label_text = 'This is not the image of a car with accuracy ' + \
            str(score) + '%. Please upload the car image.'
        print(image_path)
        return render_template('front.html', text=label_text, filename=image_path)
